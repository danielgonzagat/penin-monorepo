#!/opt/et_replica1/autonomy/venv/bin/python3
...
def plan_once():
    ...
    try:
        tree = subprocess.run(["bash","-lc","(cd /opt/et_replica1/workspace && ls -laR | head -n 400) || true"], capture_output=True, text=True, timeout=30).stdout
    except Exception:
        tree = ""
    prompt = f"""
